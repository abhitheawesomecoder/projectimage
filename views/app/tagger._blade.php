        ...
        <div class="panel panel-default">
            <div class="panel-toolbar clearfix">
                <h3 class="pull-left padding-xs no-margin">
                    <img src="icons/tag.png"> <b>Interaktiver</b> Editor <a href="http://www.imagemarker.com/hilfe.html" target="blank"><img src="icons/hilfe.png" border="0"></a>
                </h3>
            ...
            <div class="panel-body">
                <div id="tag-image-container">
                    ...
                    @include("app.partials.tagger-product-modal")
...
.tag-image-marker { display: none; }
    ...
    <section id="tagger-ctrl">
        ...
        <div class="panel panel-default">
            <div class="panel-toolbar clearfix">
                <h3 class="pull-left padding-xs no-margin">
                    <img src="../icons/tag.png"> HTML-Code für Websites <a href="http://www.imagemarker.com/hilfe.html" target="blank"><img src="../icons/hilfe.png" border="0"></a>
                </h3>
