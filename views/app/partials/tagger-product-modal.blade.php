    ...
    <div class="modal-dialog" style="width: 300px; margin-top: 0px;">
	  ...
	  border-radius: 3px 3px 3px 3px;">
            <div id="modal-body-test" class="modal-body" style="display: block; color: #000;">
                <p><h3>So funktioniert´s!</h3><b>Interaktive Gestaltung</b></p><br>
                ...
                <div class="tab-content">
                    ...
                    <div class="tab-pane active" id="create-product">
                        <div class="form-group">
                            <input type="text" class="form-control" id="input-title" placeholder="Titel (max. 50 Zeichen)" maxlength="50" required>
                        </div>
                        <div class="form-group">
                        ...
                        <div class="form-group">
						<span style="float: left; padding-right: 10px; padding-bottom: 5px; color: #000;"><b>Preis</b> in Bild anzeigen:</span>
