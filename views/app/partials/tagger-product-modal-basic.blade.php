                ...
                <div class="tab-content">
                    ...
                    <div class="tab-pane active" id="create-product">
                        <div class="form-group">
                            <input type="text" class="form-control" data-type="basic" id="input-title" placeholder="Titel (max. 50 Zeichen)" maxlength="50" required>
                        </div>
                        <div class="form-group">
						...
						<span style="float: left; padding-right: 10px; padding-bottom: 5px; color: #000;"><b>Preis</b> im Bild anzeigen:</span>
                        ...
                        <div id="color-div" class="text-left" style="float: left;color: #fff;margin-top: -7px;">
                         ...
                         <!--    <a id="color-blue" class="color-1" style="margin-left: 5px; margin-top: 5px; display: inline-block;"><img width="30" height="30" src="http://imagemarker.com/apps/icons/imagemarker/blue.png"></a>
                          ...
                          -->    @foreach($tags_icons as $icon)
                                ...
                                @endif
                            @endforeach
							 <a href="http://imagemarker.com/apps/upgrade" target="blank"><img src="/apps/icons/iconsupgrade.png"></a>
                        </div>
                        ...
                        <br><br><a href="http://imagemarker.com/apps/upgrade" target="blank">Neue Funktionen freischalten</a>
					<p>
