...
<form id="edit_form" action="" method="post">
                    ...
                    <div class="tab-pane active" id="create-product">
                        ...
                        <span style="float: left; padding-right: 10px; padding-bottom: 5px; color: #000;"><b>Preisanzeige</b> im Bild:</span>
                            <input type="text" class="form-control" id="input-price" name="price" value="{{ $product->price }}" placeholder="Preis in EUR" maxlength="8">
                        </div>

                        <div class="form-group">
                        <span style="float: left; padding-right: 10px; padding-bottom: 5px; color: #000;"><b>YouTube</b> Video verknüpfen:</span>
                            <input type="text" class="form-control" name="youtube" id="input-youtube" value="{{ $product->youtube }}" placeholder="Link zum YouTube Video" maxlength="1000"  >
                        </div>
                        ...
                        <div class="form-group">
                            <input type="text" class="form-control" id="input-button-name" name="button" value="{{ $product->button }}"
