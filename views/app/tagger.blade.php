            ...
            <div class="panel-toolbar clearfix">
                <h3 class="pull-left padding-xs no-margin">
                    ...
                    @else(Auth::user()->premium == 2)
                     ...
                     <img src="icons/tag.png"> <b>Interaktiver</b> Editor (Plus) <a href="http://www.imagemarker.com/help.html" target="blank"><img src="icons/hilfe.png" border="0"></a>
            ...
            <div class="panel-body">
                <div id="tag-image-container">
                    @if(Auth::user()->premium == 0)
                      ...
                      @include("app.partials.tagger-product-modal-basic")

                    @elseif(Auth::user()->premium == 1)

                      @include("app.partials.tagger-product-modal-premium")
